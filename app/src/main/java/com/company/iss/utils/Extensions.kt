...
fun ImageView.loadImage(resource: String?, placeholder: Int = R.drawable.image_placeholder_square) = Glide.with(this.context).load(resource).placeholder(placeholder).error(placeholder).into(this)
